    ...
    with open (filedirec,'r') as fin:
        ...
        for line in fin:
            if(line[0]!='#'):
                ...
                key=items[0]+'_'+items[1]+'_'+items[3]+'_'+items[4]
...
df=df.loc[:, (df.sum() > 1) ]
df.to_csv('/projects/p30007/Zexian/Alignment/BBCAR_NEW/administrative/Step35data/somatic_mutations_all.csv', line_terminator='\n')

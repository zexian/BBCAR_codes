...
''')    
 ...
 #       bam_string_blood=''
    ...
    #     #base recalibrate
        ...
        print >> script, GATKtool+' -nct 12 -T MuTect2 -R '+hg19Reference+' -I:tumor '+recalBam_blood+' --cosmic /projects/p30007/Zexian/reference/hg19/CosmicCodingMuts_chr_M_sorted.vcf --dbsnp '+dbsnp+' --artifact_detection_mode -L '+interval+' -o '+ OutputFolder_normal+SampleName+'.vcf'
